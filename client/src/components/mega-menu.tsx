...
export default function MegaMenu() {
  return (
    <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-[800px] max-w-[90vw] bg-white border border-gray-200 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 mt-2 z-50">
      <div className="p-6">
