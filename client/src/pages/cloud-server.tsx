    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
              🛠️ Tự Xây Dựng Cấu Hình Cloud Server
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Tùy chỉnh cấu hình server theo nhu cầu cụ thể với bảng giá minh bạch
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-2xl font-bold text-gray-800 mb-6">💵 Đơn Giá Thành Phần</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    <Cpu className="text-blue-600" size={20} />
                    <span className="font-medium">CPU (1 Core)</span>
                  </div>
                  <span className="text-lg font-bold text-blue-600">60.000 VNĐ/tháng</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    <Monitor className="text-green-600" size={20} />
                    <span className="font-medium">RAM (1 GB)</span>
                  </div>
                  <span className="text-lg font-bold text-green-600">60.000 VNĐ/tháng</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    <HardDrive className="text-purple-600" size={20} />
                    <span className="font-medium">SSD (1 GB)</span>
                  </div>
                  <span className="text-lg font-bold text-purple-600">3.000 VNĐ/tháng</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    <Database className="text-gray-600" size={20} />
                    <span className="font-medium">HDD (1 GB)</span>
                  </div>
                  <span className="text-lg font-bold text-gray-600">1.000 VNĐ/tháng</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    <Globe className="text-orange-600" size={20} />
                    <span className="font-medium">IP tĩnh (1 IP)</span>
                  </div>
                  <span className="text-lg font-bold text-orange-600">100.000 VNĐ/tháng</span>
                </div>
                <div className="flex justify-between items-center py-3">
                  <div className="flex items-center gap-3">
                    <Network className="text-indigo-600" size={20} />
                    <span className="font-medium">Băng thông (100 Mbps)</span>
                  </div>
                  <span className="text-lg font-bold text-indigo-600">100.000 VNĐ/tháng</span>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-white rounded-lg shadow-lg p-8"
            >
              <h3 className="text-2xl font-bold text-gray-800 mb-6">⏳ Chu Kỳ Thanh Toán</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 bg-gray-50 rounded-lg px-4">
                  <span className="font-medium">1 tháng</span>
                  <span className="text-lg font-bold text-gray-600">Giá gốc</span>
                </div>
                <div className="flex justify-between items-center py-3 bg-green-50 rounded-lg px-4 border border-green-200">
                  ...
                  <span className="text-lg font-bold text-green-600">Giảm 3%</span>
                </div>
                <div className="flex justify-between items-center py-3 bg-green-50 rounded-lg px-4 border border-green-300">
                  <span className="font-medium">6 tháng</span>
                  <span className="text-lg font-bold text-green-600">Giảm 6%</span>
                </div>
                <div className="flex justify-between items-center py-3 bg-blue-50 rounded-lg px-4 border border-blue-300">
                  <span className="font-medium">12 tháng</span>
                  <span className="text-lg font-bold text-blue-600">Giảm 12%</span>
                </div>
                <div className="flex justify-between items-center py-3 bg-purple-50 rounded-lg px-4 border border-purple-300">
                  <span className="font-medium">24 tháng</span>
                  <span className="text-lg font-bold text-purple-600">Giảm 24%</span>
                </div>
                <div className="flex justify-between items-center py-3 bg-red-50 rounded-lg px-4 border border-red-300">
                  <span className="font-medium">36 tháng</span>
                  <span className="text-lg font-bold text-red-600">Giảm 36%</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-8 border border-green-200">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">🎁 Dịch Vụ Đi Kèm (Miễn Phí)</h3>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center">
                  <div className="bg-green-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3">
                    <Shield className="text-green-600" size={24} />
                  </div>
                  <h4 className="font-semibold text-gray-800 mb-2">SSL Certificate</h4>
                  <p className="text-sm text-gray-600">Bảo mật HTTPS miễn phí</p>
                </div>
                <div className="text-center">
                  <div className="bg-blue-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3">
                    <BarChart className="text-blue-600" size={24} />
                  </div>
                  <h4 className="font-semibold text-gray-800 mb-2">Monitoring & Alert</h4>
                  <p className="text-sm text-gray-600">Giám sát server 24/7</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">Support kỹ thuật cơ bản</p>
                </div>
                <div className="text-center">
                  <div className="bg-orange-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3">
                    <Settings className="text-orange-600" size={24} />
                  </div>
                  <h4 className="font-semibold text-gray-800 mb-2">Migration Service</h4>
                  <p className="text-sm text-gray-600">Chuyển dữ liệu miễn phí</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">➕ Dịch Vụ Bổ Sung (Có Phí)</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="font-semibold text-gray-800">Server Management</h4>
                    <span className="text-lg font-bold text-blue-600">500.000 VNĐ/tháng</span>
                  </div>
                  <p className="text-sm text-gray-600">Quản lý server toàn diện, bảo trì, cập nhật hệ thống</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="font-semibold text-gray-800">Database Optimization</h4>
                    <span className="text-lg font-bold text-green-600">1.000.000 VNĐ/lần</span>
                  </div>
                  <p className="text-sm text-gray-600">Tối ưu hóa hiệu suất database, query optimization</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="font-semibold text-gray-800">Load Balancer</h4>
                    <span className="text-lg font-bold text-purple-600">2.000.000 VNĐ/tháng</span>
                  </div>
                  <p className="text-sm text-gray-600">Cân bằng tải, high availability cho ứng dụng</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="font-semibold text-gray-800">AI/ML Support</h4>
                    <span className="text-lg font-bold text-red-600">2.000.000 VNĐ/tháng</span>
                  </div>
                  <p className="text-sm text-gray-600">Hỗ trợ GPU chuyên dụng, framework AI/ML</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Cần Tư Vấn Cấu Hình Phù Hợp?</h3>
              <p className="text-lg mb-6 opacity-90">
                Đội ngũ chuyên gia sẽ tư vấn cấu hình tối ưu cho nhu cầu cụ thể của bạn
              </p>
              <Button 
                size="lg"
